  ...
  return {
    ...
    "DFF_PC":{
           ...
           "ff":{"out":"Io0,IQB",
                 "next_state":"i0",
                 "clocked_on":"c0"},
           "vcode":"reg notifier; udp_iq_ff_n inst (o0, 1'b0, 1'b0, c0, i0, notifier, vdd, vss);",
           "expect":
           [
    ...
    "DFF_NC":{
           ...
           "ff":{"out":"Io0,IQB",
                 "next_state":"i0",
                 "clocked_on":"(!c0)"},
           "vcode":"reg notifier; wire clkn_int; wire d_int; wire iq1; not (clkn_int, c0); not (d_int, i0); udp_iq_ff_n inst (iq1, 1'b0, 1'b0, clkn_int, d_int, notifier, vdd, vss); not (o0, iq1);",
           "expect":
           [
    ...
    "DFF_PC_NR":{
           ...
           "ff":{"out":"Io0,IQB",
                 ...
                 "clocked_on":"c0",
                 "clear":"(!r0)"},
           "vcode":"reg notifier; wire p_int; wire d_int; wire iq1; not (p_int, r0); not (d_int, i0); udp_iq_ff_n inst (iq1, 1'b0, p_int, c0, d_int, notifier, vdd, vss); not (o0, iq1);",
           "expect":
           [
             ...
             MyExpectCell(pin_tr=["o0","r0"], pin_oirc=["o0","i0","r0","c0"], ival={"o":["1"],"i":["1"],"b":[],"c":["p"],"r":["1"]}
                        ,meas_types=["clear","power_tout"],tmg_sense="pos",arc_oirc=["f","1","f","0"], tmg_when="", specify="(negedge r0 => (o0 +: 1'b0)) = (0,0);"),
    ...
    "DFF_PC_NS":{
           ...
           "ff":{"out":"Io0,IQB",
                 ...
                 "clocked_on":"c0",
                 "preset":"(!s0)"},
           "vcode":"reg notifier; wire c_int; wire d_int; wire iq1; not (c_int, s0); not (d_int, i0); udp_iq_ff_n inst (iq1, c_int, 1'b0, c0, d_int, notifier, vdd, vss); not (o0, iq1);",
           "expect":
           [
             ...
             MyExpectCell(pin_tr=["o0","s0"], pin_oirc=["o0","i0","s0","c0"], ival={"o":["0"],"i":["0"],"b":[],"c":["p"],"s":["1"]}
                        ,meas_types=["preset","power_tout"],tmg_sense="neg",arc_oirc=["r","0","f","0"], tmg_when="", specify="(negedge s0 => (o0 -: 1'b1)) = (0,0);"),
             #--- setup
    ...
    "DFF_NC_NR":{
           ...
           "ff":{"out":"Io0,IQB",
                 ...
                 "clocked_on":"(!c0)",
                 "clear":"(!r0)"},
           "vcode":"reg notifier; wire clkn_int; wire p_int; wire d_int; wire iq1; not (clkn_int, c0); not (p_int, r0); not (d_int, i0); udp_iq_ff_n inst (iq1, 1'b0, p_int, clkn_int, d_int, notifier, vdd, vss); not (o0, iq1);",
           "expect":
           [
             ...
             MyExpectCell(pin_tr=["o0","r0"], pin_oirc=["o0","i0","r0","c0"], ival={"o":["1"],"i":["1"],"b":[],"c":["n"],"r":["1"]}
                        ,meas_types=["clear","power_tout"],tmg_sense="pos",arc_oirc=["f","1","f","1"], tmg_when="", specify="(negedge r0 => (o0 +: 1'b0)) = (0,0);"),
             #--- setup
    ...
    "DFF_NC_NS":{
           ...
           "ff":{"out":"Io0,IQB",
                 ...
                 "clocked_on":"(!c0)",
                 "preset":"(!s0)"},
           "vcode":"reg notifier; wire clkn_int; wire c_int; wire d_int; wire iq1; not (clkn_int, c0); not (c_int, s0); not (d_int, i0); udp_iq_ff_n inst (iq1, c_int, 1'b0, clkn_int, d_int, notifier, vdd, vss); not (o0, iq1);",
           "expect":
           [
             #--- q delay (clkn neg -> q) + power_tout  #ISS-00135: CLK-on-VREL 複製廃止（dffrsnq 新方式に統一）
             ...
             MyExpectCell(pin_tr=["o0","s0"], pin_oirc=["o0","i0","s0","c0"], ival={"o":["0"],"i":["0"],"b":[],"c":["n"],"s":["1"]}
                        ,meas_types=["preset","power_tout"],tmg_sense="neg",arc_oirc=["r","0","f","1"], tmg_when="", specify="(negedge s0 => (o0 -: 1'b1)) = (0,0);"),
             #--- setup
    ...
    "DFF_PC_NR_NS":{
           ...
           "ff":{"out":"Io0,IQB",
                 ...
                 "clear_preset_var1":"L",
                 "clear_preset_var2":"H"},
           "vcode":"reg notifier; wire p_int; wire c_int; wire d_int; wire iq1; not (p_int, r0); not (c_int, s0); not (d_int, i0); udp_iq_ff_hn inst (iq1, c_int, p_int, c0, d_int, notifier, vdd, vss); not (o0, iq1);",
           "expect":
           [
    ...
    "DFF_NC_NR_NS":{
           ...
           "ff":{"out":"Io0,IQB",
                 ...
                 "clear_preset_var1":"L",
                 "clear_preset_var2":"H"},
           "vcode":"reg notifier; wire clkn_int; wire p_int; wire c_int; wire d_int; wire iq1; not (clkn_int, c0); not (p_int, r0); not (c_int, s0); not (d_int, i0); udp_iq_ff_hn inst (iq1, c_int, p_int, clkn_int, d_int, notifier, vdd, vss); not (o0, iq1);",
           "expect":
           [
             #--- q delay (clkn neg -> q) + power_tout  #ISS-00135: CLK-on-VREL 複製廃止（dffrsnq 新方式に統一）
    ...
    "DFFB_PC_PR":{
           ...
           [
             ...
             MyExpectCell(pin_tr=["o0","r0"], pin_oirc=["o0","i0","r0","c0"], ival={"o":["1","0"],"i":["1"],"b":[],"c":["p"],"r":["0"]}
                        ,meas_types=["clear","power_tout"], tmg_sense="neg",arc_oirc=["f","1","r","0"], tmg_when="", specify="(posedge r0 => (o0 +: 1'b0)) = (0,0);"),
             #--- preset (同じ R rise で o1=QB rise、 Q の補集合)
             MyExpectCell(pin_tr=["o1","r0"], pin_oirc=["o1","i0","r0","c0"], ival={"o":["1","0"],"i":["1"],"b":[],"c":["p"],"r":["0"]}
                        ,meas_types=["preset","power_tout"], tmg_sense="pos",arc_oirc=["r","1","r","0"], tmg_when="", specify="(posedge r0 => (o1 +: 1'b1)) = (0,0);"),
    ...
    "DFFB_PC_NS":{
           ...
           [
             ...
             MyExpectCell(pin_tr=["o1","s0"], pin_oirc=["o1","i0","s0","c0"], ival={"o":["0","1"],"i":["0"],"b":[],"c":["p"],"s":["1"]}
                        ,meas_types=["clear","power_tout"], tmg_sense="pos",arc_oirc=["f","0","f","0"], tmg_when="", specify="(negedge s0 => (o1 +: 1'b0)) = (0,0);"),
