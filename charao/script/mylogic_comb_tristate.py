    ...
    "BUFZ":{
      ...
      "expect":
             [
               ...
               MyExpectCell(pin_oir=["o0","i0","i0"], ival={"o":["0"],"i":["0","1"]}, mondrv_oir=["1","1","1"]
                           ,meas_types=["delay","power_tout"], tmg_sense="pos", arc_oir=["r","r","r"], tmg_when="i1", specify=""),
               MyExpectCell(pin_oir=["o0","i0","i0"], ival={"o":["1"],"i":["1","1"]}, mondrv_oir=["0","0","0"]
                           ,meas_types=["delay","power_tout"], tmg_sense="pos", arc_oir=["f","f","f"], tmg_when="i1", specify="(i0 => o0) = (0,0);"),
               ...
               MyExpectCell(pin_oir=["o0","i0","i1"], ival={"o":["0"],"i":["0","1"]}, mondrv_oir=["1","0","0"]
                           ,meas_types=["three_state_disable"], tmg_sense="neg", arc_oir=["r","s","f"], tmg_when="", specify=""),
               ...
               MyExpectCell(pin_oir=["o0","i0","i0"], ival={"o":["d"],"i":["1","0"]}, mondrv_oir=["0","0","0"]
                           ,meas_types=["leakage"], tmg_sense="non", arc_oir=["s","s","s"], tmg_when="i0&!i1", specify=""),
               MyExpectCell(pin_oir=["o0","i0","i0"], ival={"o":["d"],"i":["0","1"]}, mondrv_oir=["0","1","1"]
                           ,meas_types=["leakage"], tmg_sense="non", arc_oir=["s","s","s"], tmg_when="!i0&i1", specify=""),
               MyExpectCell(pin_oir=["o0","i0","i0"], ival={"o":["u"],"i":["1","1"]}, mondrv_oir=["1","1","1"]
                           ,meas_types=["leakage"], tmg_sense="non", arc_oir=["s","s","s"], tmg_when="i0&i1", specify=""),
             ]
    },
    #---------------------------------------------------------------------------------------
    ...
    "INVZ":{
      ...
      "expect":
             [
               ...
               MyExpectCell(pin_oir=["o0","i0","i0"], ival={"o":["1"],"i":["0","1"]}, mondrv_oir=["1","0","0"]
                           ,meas_types=["delay","power_tout"], tmg_sense="neg", arc_oir=["f","r","r"], tmg_when="i1", specify=""),
               MyExpectCell(pin_oir=["o0","i0","i0"], ival={"o":["0"],"i":["1","1"]}, mondrv_oir=["0","1","1"]
                           ,meas_types=["delay","power_tout"], tmg_sense="neg", arc_oir=["r","f","f"], tmg_when="i1", specify="(i0 => o0) = (0,0);"),
               ...
               MyExpectCell(pin_oir=["o0","i0","i1"], ival={"o":["1"],"i":["0","1"]}, mondrv_oir=["0","0","0"]
                           ,meas_types=["three_state_disable"], tmg_sense="neg", arc_oir=["f","s","f"], tmg_when="", specify=""),
               #--- leakage (4 conditions: !EN&!I / EN&!I / !EN&I / EN&I)
               MyExpectCell(pin_oir=["o0","i0","i0"], ival={"o":["d"],"i":["0","0"]}, mondrv_oir=["0","0","0"]
                           ,meas_types=["leakage"], tmg_sense="non", arc_oir=["s","s","s"], tmg_when="!i0&!i1", specify=""),
               MyExpectCell(pin_oir=["o0","i0","i0"], ival={"o":["d"],"i":["1","0"]}, mondrv_oir=["0","0","0"]
                           ,meas_types=["leakage"], tmg_sense="non", arc_oir=["s","s","s"], tmg_when="i0&!i1", specify=""),
               MyExpectCell(pin_oir=["o0","i0","i0"], ival={"o":["u"],"i":["0","1"]}, mondrv_oir=["1","0","1"]
                           ,meas_types=["leakage"], tmg_sense="non", arc_oir=["s","s","s"], tmg_when="!i0&i1", specify=""),
               MyExpectCell(pin_oir=["o0","i0","i0"], ival={"o":["d"],"i":["1","1"]}, mondrv_oir=["0","1","1"]
                           ,meas_types=["leakage"], tmg_sense="non", arc_oir=["s","s","s"], tmg_when="i0&i1", specify=""),
             ]
    },
    "HOLD":{
      ...
      "expect":
             [
               ...
               MyExpectCell(pin_oir=["b0","b0","b0"], ival={"o":[],"i":[],"b":["0"]}, mondrv_oir=["0","0","0"]
                           ,meas_types=["leakage"] ,tmg_sense="non",arc_oir=["s","s","s"], tmg_when="!b0", specify=""),
