...
class MyItemTemplate(BaseModel):
  kind   : Literal["leakage","const","delay","delay_c2c","delay_i2c","delay_c2i","delay_i2i","mpw","passive","power_tout","power_tin","power_c2c","power_i2c","power_c2i","power_i2i"]="delay";
  grid   : str ="";         #"7x7"
  name   : str ="";         #"x1" 
